...
set CHROME_DRIVER=-Dwebdriver.chrome.driver="../drivers/win/chromedriver.exe"
set FIREFOX_DRIVER=-Dwebdriver.gecko.driver="../drivers/win/geckodriver.exe"
set IE_DRIVER=-Dwebdriver.ie.driver="../drivers/win/IEDriverServer.exe"
