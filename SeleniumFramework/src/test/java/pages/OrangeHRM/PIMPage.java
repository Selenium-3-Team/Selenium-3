...
public class PIMPage extends GeneralPage {
	...
	private final Element txtEmployeeId = new Element("//label[text()='Employee Id']/parent::div/following-sibling::div//input");
	private final Element btnSave = new Element("//button[@type='submit']");
	private final Element txtEmployeeName = new Element("//div[@class='orangehrm-edit-employee-name']//h6[text()='%s']");
