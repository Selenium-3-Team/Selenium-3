...
/**
 * An ExtentTest map holds the information of thread ids and ExtentTest
 * instances ExtentReports instance created by calling getInstance() method from
 * ExtentReportManager
 */
public class ExtentTestManager {
	...
	/**
	 * At this method, an instance of ExtentTest created and put into extentTestMap
	 * with current thread id
	 * 
