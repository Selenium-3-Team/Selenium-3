...
/**
 * Driver is a remote control that enables introspection and control of user agents(browsers) 
 */
public class Driver {
	...
	/**
	 * Send future commands to a different frame or window and select a frame by its name or ID
	...
	/**
	 * Send future commands to a different frame or window and select a frame by index
	...
	/**
	 * Send future commands to a different frame or window and select the parent frame
	 */
	...
	/**
	 * Send future commands to a different frame or window and select the default frame
	 */
	 ...
	 * @param by - The locating mechanism to use
	 * @return A list of all matching web elements, or an empty list if nothing matches
	 */
