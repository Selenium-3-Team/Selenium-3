...
/**
 * Driver factory pattern, where only the concrete classes need to know exactly how to create a new instance.
 * This helps create a simple one way to create WebDriver instance.
 * Containing all the concrete implementations for every browser. If we want to create an instance of Chrome Driver, we just pass the chrome driver property
 * and it will get type and mode of the corressponding driver class.  
 */
public class DriverFactory {
	...
	/**
	 * Depend on driver property to create new instance of driver(Chrome, Firefox,...). 
	 * It gets type and mode of the driver to catch exactly each resource for the instance   
	 * @param property - Driver property contains set of attributes(Type, Platform, Mode,...)
